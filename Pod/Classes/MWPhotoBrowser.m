...
- (void)viewDidLoad {
    ...
    // Toolbar
    _toolbar = [[UIToolbar alloc] initWithFrame:[self frameForToolbarAtOrientation:DEVICE_ORIENTATION]];
...
- (void)layoutVisiblePages {
	...
	// Toolbar
	_toolbar.frame = [self frameForToolbarAtOrientation:DEVICE_ORIENTATION];
...
- (void)setControlsHidden:(BOOL)hidden animated:(BOOL)animated permanent:(BOOL)permanent {
    ...
    if ([self areControlsHidden] && !hidden && animated) {
        ...
        // Toolbar
        _toolbar.frame = CGRectOffset([self frameForToolbarAtOrientation:DEVICE_ORIENTATION], 0, animatonOffset);
